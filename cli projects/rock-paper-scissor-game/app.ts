...
while(condition){
    ...
    let showPlayerChoices = ()=>{
        console.log(
            chalk.rgb(203,157,126).bold("\n\tYour Choice: ")+ 
            chalk.bold.underline.rgb(203,232,150)(questions.user) + "\n"
        );
        console.log(
            chalk.rgb(203,157,126).bold("\tComputer Choice: ")+
    ...
    console.log(
        chalk.bold.bgRgb(100,110,120)(" Your Points: ")+ 
